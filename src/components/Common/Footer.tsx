...
export function Footer() {
  return (
    <footer className="w-full bg-[#F5F6F7] p-4">
      <div className="flex flex-row flex-wrap items-center justify-center pl-4 pr-4 bg-[#F5F6F7] text-center md:justify-between">
