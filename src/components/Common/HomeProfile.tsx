...
export const HomeProfile = () => {
  ...
  return (
    <div>
      <div className="  flex items-center justify-start sm:flex-row">
        <img
        ...
        <div className="sm:ml-10">
          ...
          <p className="mb-8 font-bold sm:text-3xl">준희님, 안녕하세요 !</p>
      ...
      <div className="size">
        <p className="ml-72 mt-12 text-xl font-semibold">현재 함께하는 친구</p>
      </div>
      <div
        className=" ml-40
       grid w-96 grid-cols-3"
      >
        {[...Array(5)].map((a, i) => {
          return (
            <img
            className={`border-brownw-25 m-10 h-20 rounded-full border-2 border-solid object-cover transition duration-1000 ease-in-out sm:mb-0 ${isWrite ? 'border-green-700' : 'border-gray-300'}`}
            src={imgUrl}
              alt="나의 프로필 사진"
            />
          );
